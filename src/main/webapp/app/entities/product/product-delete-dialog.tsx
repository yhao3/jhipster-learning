...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterlearningApp.product.delete.question">
        <Translate contentKey="jhipsterlearningApp.product.delete.question" interpolate={{ id: productEntity.id }}>
