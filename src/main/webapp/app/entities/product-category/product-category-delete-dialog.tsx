...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterlearningApp.productCategory.delete.question">
        <Translate contentKey="jhipsterlearningApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
