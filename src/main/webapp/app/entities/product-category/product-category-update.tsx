  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterlearningApp.productCategory.home.createOrEditLabel" data-cy="ProductCategoryCreateUpdateHeading">
            <Translate contentKey="jhipsterlearningApp.productCategory.home.createOrEditLabel">Create or edit a ProductCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterlearningApp.productCategory.productCategoryName')}
              ...
              />
              <UncontrolledTooltip target="productCategoryNameLabel">
                <Translate contentKey="jhipsterlearningApp.productCategory.help.productCategoryName" />
              </UncontrolledTooltip>
              <ValidatedField
                label={translate('jhipsterlearningApp.productCategory.isShow')}
                id="product-category-isShow"
                name="isShow"
                data-cy="isShow"
                check
                type="checkbox"
