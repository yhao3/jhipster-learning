...
/**
 * REST controller for managing {@link org.yhao3.jhipsterlearning.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
public class ProductCategoryResource {
    ...
    public ResponseEntity<List<ProductCategoryDTO>> searchProductCategories(
